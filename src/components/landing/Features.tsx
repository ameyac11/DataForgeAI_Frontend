...
export function Features() {
  return (
    <section id="features" className="py-20 sm:py-24 md:py-32 lg:py-36 bg-[#18181b]">
      <div className="container px-4 sm:px-6">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium mb-4 sm:mb-6 text-white">
            Powerful Features
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-white/5 flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300`}>
                <feature.icon className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
              </div>
              <h3 className="text-lg sm:text-xl font-medium mb-3 sm:mb-4 text-white">
                {feature.title}
              </h3>
